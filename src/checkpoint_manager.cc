...
bool CheckpointManager::addNewCheckpoint_UNLOCKED(uint64_t id) {
    ...
    // If any of cursors reached to the end of its current checkpoint, move it to
    // the next checkpoint. Note that the replication cursors cannot skip a
    // checkpoint_end meta item.
